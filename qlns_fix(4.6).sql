...
('NV05', N'Trần Song Toàn', N'Nam', 0, N'013 Đường ABC, TP.HCM', 'toantsps38557@gmail.com', 134567890)
...
exec [dbo].[DoiMK] @email = 'namntnps38555@gmail.com', @oldpass = '123', @newpass = '12345'
...
-- Danh sách sản phẩm
create proc DsSanPham
@sotrang INT,
@kichthuoctrang int
as
begin
	 select MasanPham, TenSanPham, SoLuong, LoaiSanPham, DonGia, HinhAnh, GhiChu from SanPham where tinhtrangsanpham = 1
	 	 order by MasanPham 
	 OFFSET (@sotrang - 1) * @kichthuoctrang ROWS
	 FETCH NEXT @kichthuoctrang ROWS ONLY;
end
...
create proc getTongDataSanPham
as
begin
